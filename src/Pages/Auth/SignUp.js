            ...
            <div className="card w-96 bg-base-100 shadow-xl">
                <div className="card-body">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        {signInError}
                        <input className='btn btn-info w-full max-w-xs' value="SignUp" type="submit" />
                    </form>
                    <small>Already have an account,<Link to='/login' className='text-primary'>Log in</Link> </small>
